...
export default function AuthForm(){
    ...
    const handleSubmit = async(e: React.FormEvent) => {
        ...
        try{
            ...
            if (data?.session) window.location.href = "/movies";
        } catch(err: any) {
        ...
        <>
            ...
            {showToast && (
                    <motion.div
                        ...
                        animate={{ opacity: 1 }}
                        exit={{ opacity: 0 }}
                        className="fixed top-6 left-1/2 -translate-x-1/2 bg-green-600/90 text-white px-4 py-2 rounded-lg shadow-xl z-[99999] backdrop-blur-sm"
                    >
